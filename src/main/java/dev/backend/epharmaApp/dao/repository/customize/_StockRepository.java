...
/**
 * Repository customize : Stock.
 */
@Repository
public interface _StockRepository {
	default List<String> _generateCriteria(StockDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {

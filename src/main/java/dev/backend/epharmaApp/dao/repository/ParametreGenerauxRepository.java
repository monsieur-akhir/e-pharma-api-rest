...
import dev.backend.epharmaApp.dao.repository.customize._ParametreGenerauxRepository;
...
public interface ParametreGenerauxRepository extends JpaRepository<ParametreGeneraux, Integer>, _ParametreGenerauxRepository {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<ParametreGenerauxDto> request, HashMap<String, java.lang.Object> param, Locale locale) throws Exception {
		// main query
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(ParametreGenerauxDto dto, HashMap<String, java.lang.Object> param, Integer index,  Locale locale) throws Exception{

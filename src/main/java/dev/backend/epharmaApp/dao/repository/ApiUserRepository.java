...
import dev.backend.epharmaApp.dao.repository.customize._ApiUserRepository;
...
public interface ApiUserRepository extends JpaRepository<ApiUser, Integer>, _ApiUserRepository {
	...
	/**
	 * Finds List of ApiUser by using apiUsersDto as a search criteria.
	 * 
	 * @param request, em
	 * @return A List of ApiUser
	 * @throws DataAccessException,ParseException
	 */
	default List<ApiUser> getByCriteria(Request<ApiUsersDto> request, EntityManager em, Locale locale) throws DataAccessException, Exception {
	...
	/**
	 * Finds count of ApiUser by using apiUsersDto as a search criteria.
	 * 
	 * @param request, em
	 * @return Number of ApiUser
	 * 
	 */
	default Long count(Request<ApiUsersDto> request, EntityManager em, Locale locale) throws DataAccessException, Exception  {
	 ...
	 * @throws Exception
	 */
	default String getWhereExpression(Request<ApiUsersDto> request, HashMap<String, Object> param, Locale locale) throws Exception {
		// main query
		ApiUsersDto dto = request.getData() != null ? request.getData() : new ApiUsersDto();
		...
		if (request.getDatas() != null && !request.getDatas().isEmpty()) {
			Integer index = 1;
			for (ApiUsersDto elt : request.getDatas()) {
	 ...
	 * @throws Exception
	 */
	default String generateCriteria(ApiUsersDto dto, HashMap<String, Object> param, Integer index,  Locale locale) throws Exception{

...
import dev.backend.epharmaApp.jobs.NodeDto;
...
@Configuration
@ComponentScan("dev.backend.epharmaApp")
public class RedisConfig {
	...
	public JedisConnectionFactory jedisConnectionFactory() {
		...
		jedisConnectionFactory.setDatabase(2); // Sélection de la base de données 1
	...
	@Bean
	public RedisTemplate<String, UsersDto> redisTemplate() {
		final RedisTemplate<String, UsersDto> template = new RedisTemplate<>();
		...
		template.setHashValueSerializer(new Jackson2JsonRedisSerializer<>(UsersDto.class));
		template.setValueSerializer(new Jackson2JsonRedisSerializer<>(UsersDto.class));

...
public class LdapService {
	...
	public List<UsersDto> getAllUser(String userName) {
		AndFilter andFilter = new AndFilter();
	...
	public List<UsersDto> getUserByLogin(String userName) {
		AndFilter andFilter = new AndFilter();
		andFilter.and(new LikeFilter("sAMAccountName", userName));
		return ldapTemplate.search("", andFilter.encode(), new PersonAttributeMapper());
	...
	public List<UsersDto> getAllUserByNom(String userName) {
		AndFilter andFilter = new AndFilter();
	...
	public List<UsersDto> getAllUserByPrenom(String givenName) {
		AndFilter andFilter = new AndFilter();
	...
	public List<UsersDto> getAllUserByTelephone(String telephone) {
		AndFilter andFilter = new AndFilter();
	...
	public List<UsersDto> getAllUserByMatricule(String matricule) {
		AndFilter andFilter = new AndFilter();
	...
	public List<UsersDto> searchUser(String login) {
		AndFilter andFilter = new AndFilter();
		andFilter.and(new EqualsFilter("sAMAccountName", login));
	...
	public List<UsersDto> searchUserByMobile(String phone) {
		AndFilter andFilter = new AndFilter();
		andFilter.and(new EqualsFilter("telephoneNumber", phone));
		return ldapTemplate.search("", andFilter.encode(), new PersonAttributeMapper());
	}

	public List<UsersDto> searchUserByPrenoms(String prenom) {
		AndFilter andFilter = new AndFilter();
		andFilter.and(new EqualsFilter("givenName", prenom));
		return ldapTemplate.search("", andFilter.encode(), new PersonAttributeMapper());
	}

	public List<UsersDto> searchUserByNom(String nom) {
		AndFilter andFilter = new AndFilter();
		andFilter.and(new EqualsFilter("sn", nom));
		return ldapTemplate.search("", andFilter.encode(), new PersonAttributeMapper());
	}

	public List<UsersDto> searchUserByMatricule(String matricule) {
		AndFilter andFilter = new AndFilter();
		andFilter.and(new EqualsFilter("physicalDeliveryOfficeName", matricule));

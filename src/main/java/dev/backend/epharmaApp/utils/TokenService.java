...
public class TokenService {
    ...
    public String generateAccessToken(Users user) {
        log.info("Génération du token d'accès pour l'utilisateur ID: {}", user.getUserId());
        return Jwts.builder()
                .setSubject(user.getEmail())
                .claim("userId", user.getUserId())
                .claim("roleId", user.getRoles().getRoleId())
    ...
    public String generateRefreshToken(Users user) {
        log.info("Génération du refresh token pour l'utilisateur ID: {}", user.getUserId());
        return Jwts.builder()
                .setSubject(user.getEmail())
                .claim("userId", user.getUserId())
                .claim("roleId", user.getRoles().getRoleId())

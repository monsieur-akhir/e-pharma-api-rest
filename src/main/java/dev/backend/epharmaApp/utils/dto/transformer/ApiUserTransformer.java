...
public interface ApiUserTransformer {
	...
	ApiUsersDto toDto(ApiUser entity) throws ParseException;

	@IterableMapping(qualifiedBy = {FullTransformerQualifier.class})
    List<ApiUsersDto> toDtos(List<ApiUser> entities) throws ParseException;

    default ApiUsersDto toLiteDto(ApiUser entity) {
		if (entity == null) {
			return null;
		}
		ApiUsersDto dto = new ApiUsersDto();
		dto.setId( entity.getId() );
		dto.setLogin( entity.getLogin() );
		return dto;
    }

	default List<ApiUsersDto> toLiteDtos(List<ApiUser> entities) {
		if (entities == null || entities.stream().allMatch(o -> o == null)) {
			return null;
		}
		List<ApiUsersDto> dtos = new ArrayList<ApiUsersDto>();
    ...
    ApiUser toEntity(ApiUsersDto dto) throws ParseException;

    //List<ApiUser> toEntities(List<ApiUsersDto> dtos) throws ParseException;
